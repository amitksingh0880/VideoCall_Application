                ...
                {onlineUsers && onlineUsers.length > 0 ? (
                    onlineUsers.map((onlineUser) => (
                        ...
                        >
                            {/* Profile Picture */}
                            <img
                                src={onlineUser.profile.imageUrl || "/default-avatar.png"} // Replace with a default image path
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                {onlineUser.profile.fullName?.split(" ").slice(1).join(" ")}
                            </p>
                            {/* Call Button */}
                            <button className="mt-auto bg-red-600 text-white px-4 py-2 rounded-full flex items-center space-x-2 hover:bg-blue-600 transition-colors">
                                <FaVideo />
                                <span>Call</span>
                            </button>
                        </div>
